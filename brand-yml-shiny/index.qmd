...
## {background-image="images/rstudio-conf-2019.png" background-size="cover" transition="fade" transition-speed="slow"}

## {.center background-image="images/push-to-prod-welcome.png" background-size="cover"}
...
::: footer
🦋 [@grrrck.xyz](https://bsky.app/profile/grrrck.xyz){style="text-decoration: none"} &nbsp;&nbsp;&nbsp;&nbsp; 🏡 [garrickadenbuie.com](https://garrickadenbuie.com){style="text-decoration: none"}
:::