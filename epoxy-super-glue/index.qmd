...
::: {.codewindow .r .rmd style="font-size: clamp(1rem, 2vw, 2rem)"}
report-html.Rmd
...
::: {.codewindow .r .rmd .fragment fragment-index=1 style="font-size: clamp(1rem, 2vw, 2rem)"}
report-latex.Rmd
