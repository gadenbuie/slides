...
[about [1284.75]{.bg-blue} per month]{.fragment .text-gray-12 show-on=0 style="--display: inline"}
...
<div class="yes-list">
<ul>
<li class="fragment"><code>{epoxy}</code> in Reports
<ul>
<li>R Markdown and Quarto</li>
<li>Markdown, HTML, or LaTeX</li>
</ul></li>
<li class="fragment"><code>{epoxy}</code> in scripts
<ul>
<li><code>epoxy()</code></li>
<li><code>epoxy_html()</code></li>
<li><code>epoxy_latex()</code></li>
</ul></li>
</ul>
</div>
```
...
## {transition="fade" transition-speed="slow" visibility="hidden"}
...
::: {.app-code .ps-8 highlight-theme="github-dark"}
```{r}
#| code-line-numbers: "|5-7|8-9,13|10-12|17,21|18-20|11,18-20"
#| eval: false
#| echo: true
