...
<div>Infant day care costs</div>
<div>up to
<div class="d-if"><div class="d-ib typewriter" style="--delay:1s;--steps:17;--blinks:0;">[&#x60;r [med_cost_max]{.text-orange}&#x60;]{.text-blue}</div></div>
</div>
...
<div>Infant day care costs</div>
<div>up to [&#x60;r [med_cost_max]{.text-orange}&#x60;]{.text-blue}</div>
<div>a year.</div>
:::
::::
...
```{r}
#| include: false
med_cost_max <- 15416.96
```

::: {.quote-sans style="color: var(--gray-7);"}
<div>Infant day care costs</div>
<div>up to [`r med_cost_max`]{.text-orange .d-ib data-id="quote-var"}</div>
<div>a year.</div>
:::
::::
...
::: {.quote-code style="font-size: 4vw; line-height: 1.2;" data-id="quote"}
<div>Infant day care costs</div>
<div>up to [&#x60;r med_cost_max&#x60;]{.text-blue}</div>
<div>a year.</div>
:::
...
&#x60;&#x60;&#x60;{r} \
[med_cost_max]{.text-orange .d-ib data-id="quote-var"} <- \
&nbsp;&nbsp;childcare_costs |> \
&nbsp;&nbsp;[# group and summarize... |>]{.text-muted} \
&nbsp;&nbsp;filter(cost = max(cost)) |> \
&nbsp;&nbsp;pull(cost) \
...
<div>Infant day care costs</div>
<div>up to [&#x60;r [med_cost_max]{.text-orange .d-ib data-id="quote-var"}&#x60;]{.text-blue}</div>
<div>a year.</div>
:::
